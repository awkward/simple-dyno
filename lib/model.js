  ...
  _createClass(Model, [{
    ...
    value: function serialize(object) {
      ...
      if (serializer) {
        ...
        for (var _key in object) {
          if (object[_key] !== undefined) newObject[_key] = object[_key];
        }
      }
    ...
    value: function find(indexName, query) {
      ...
      var _attributesAndNamesFo = this._attributesAndNamesForQuery(query, options.operators),
          expression = _attributesAndNamesFo.expression,
          attributeNames = _attributesAndNamesFo.attributeNames,
          attributes = _attributesAndNamesFo.attributes,
          keyAttr = _attributesAndNamesFo.keyAttr;
    ...
    value: function query(indexName, _query) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var _attributesAndNamesFo2 = _this6._attributesAndNamesForQuery(_query, options.operators),
            expression = _attributesAndNamesFo2.expression,
            attributeNames = _attributesAndNamesFo2.attributeNames,
            attributes = _attributesAndNamesFo2.attributes,
            keyAttr = _attributesAndNamesFo2.keyAttr;
