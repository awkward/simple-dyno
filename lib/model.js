...
var Model = function () {
  ...
  _createClass(Model, [{
    ...
    value: function create(item) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var doCreate = function doCreate() {
          ...
          _this2.db.doc.put(params, function (err, response) {
            if (err) {
        ...
        if (!options.skipValidation && _this2.schema) {
          _this2.validate(item, _this2.schema).then(doCreate.bind(_this2)).catch(reject);
        } else {
          doCreate.call(_this2);
        }
      });
    }
  }, {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var doUpdate = function doUpdate() {
          ...
          if (_this.encryptFields) {
            ...
            try {
              for (var _iterator4 = _this.encryptFields[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                var i = _step4.value;
        ...
        if (!options.skipValidation && _this.schema) {
          _this.validate(attributes, _this4.schema).then(doUpdate).catch(reject);
        } else {
          doUpdate();
        }
      });
    ...
    value: function destroy(keyValues) {
      ...
      return new Promise(function (resolve, reject) {
        _this5.db.doc.delete(params, function (err, response) {
          if (err) {
            reject(new Error(err));
          } else {
            resolve(response);
    ...
    value: function find(indexName, query) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this6.db.doc.scan(params, function (err, response) {
          if (err) {
            reject(new Error(err));
          } else {
            if (response.Count === 0) {
    ...
    value: function query(indexName, _query) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var _attributesAndNamesFo2 = _this7._attributesAndNamesForQuery(_query, options.operators);
        ...
        // perform the query
        _this7.db.doc.query(params, function (err, response) {
          if (err) {
            reject(new Error(err));
          } else {
            if (response.Count === 0) {
    ...
    value: function get(keyValues) {
      ...
      return new Promise(function (resolve, reject) {
        _this8.db.doc.get(params, function (err, response) {
          if (err) {
            reject(new Error(err));
    ...
    value: function validate(value) {
      ...
      return new Promise(function (resolve, reject) {
        _joi2.default.validate(value, _this9.schema, function (err, result) {
